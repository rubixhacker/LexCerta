...
This describes the retained Worker adapter and its local test coverage. Worker production deployment is disabled after the [runtime qualification failure](worker-runtime-qualification.md); the Cloud Run delivery must establish equivalent telemetry and retention before launch.
