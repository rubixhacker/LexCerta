/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 58f8fc1638f5a8269d2b8f41c245362a)
// Runtime types generated with workerd@1.20260801.1 2026-08-01 
interface __BaseEnv_Env {
	OPINION_CACHE: R2Bucket;
	DB: D1Database;
	TELEMETRY: AnalyticsEngineDataset;
	BUILD_ID: "local" | "production";
	COURTLISTENER_CREDENTIAL_ID: "courtlistener-test" | "courtlistener-local" | "courtlistener-production";
	KEY_ENVIRONMENT: "test" | "production";
	API_KEY_LIMITER: DurableObjectNamespace<import("./src/worker").ApiKeyLimiter>;
	COURTLISTENER_COORDINATOR: DurableObjectNamespace<import("./src/worker").CourtListenerCoordinator>;
	TELEMETRY_TRACES: Fetcher /* lexcerta-telemetry-traces-test */ | Fetcher /* lexcerta-telemetry-traces-local */ | Fetcher /* lexcerta-telemetry-traces */;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/worker");
		durableNamespaces: "ApiKeyLimiter" | "CourtListenerCoordinator";
	}
	interface TestEnv {
		OPINION_CACHE: R2Bucket;
		DB: D1Database;
		...
		API_KEY_LIMITER: DurableObjectNamespace<import("./src/worker").ApiKeyLimiter>;
		COURTLISTENER_COORDINATOR: DurableObjectNamespace<import("./src/worker").CourtListenerCoordinator>;
		TELEMETRY_TRACES: Fetcher /* lexcerta-telemetry-traces-test */;
	}
	interface LocalEnv {
		OPINION_CACHE: R2Bucket;
		DB: D1Database;
		...
		API_KEY_LIMITER: DurableObjectNamespace<import("./src/worker").ApiKeyLimiter>;
		COURTLISTENER_COORDINATOR: DurableObjectNamespace<import("./src/worker").CourtListenerCoordinator>;
		TELEMETRY_TRACES: Fetcher /* lexcerta-telemetry-traces-local */;
	}
